  ...
  return (
    <div className="w-full grid grid-cols-2 gap-2 pt-14">
      ...
      <div className="flex flex-col">
        ...
        <div className="px-4 text-center py-4 text-darkgray font-bold">رایگان</div>
        <div className="flex items-center justify-center text-center px-4 py-4 gap-[2px]">
          <span className="text-darkgray text-xs">MB</span>
          <span>128</span>
        </div>
        <div className="flex items-center justify-center text-center px-4 py-4 gap-[2px]">
          <span className="text-darkgray text-xs">CORE</span>
          <span>0.12</span>
        </div>
      ...
      <div className="flex flex-col bg-oddBgBodyTable">
        <div className="h-24 flex-col flex items-center justify-center text-center bg-oddHeaderColumn px-4 py-6">
          <div className="font-bold text-xl">پلتفرم (PaaS)</div>
          <div className="text-sm">رایگان شروع کنید</div>
        </div>
        <div className="px-4 py-4 ">قیمت ماهانه</div>
      ...
      <div className="flex flex-col">
        ...
        <div className="text-center px-4 py-4 text-darkgray font-bold">رایگان</div>
        <div className="flex items-center justify-center text-center px-4 py-4 gap-[2px]">
          <span className="text-darkgray text-xs">MB</span>
          <span>128</span>
        </div>
